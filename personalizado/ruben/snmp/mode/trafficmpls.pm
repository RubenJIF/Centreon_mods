...
package personalizado::ruben::snmp::mode::trafficmpls;
...
sub set_oids_traffic {
    ...
    $self->{oid_in64} = '.1.3.6.1.4.1.6527.3.1.2.6.10.1.4.1'; # in B
    $self->{oid_out64} = '.1.3.6.1.4.1.6527.3.1.2.6.10.1.3.1'; # in B
